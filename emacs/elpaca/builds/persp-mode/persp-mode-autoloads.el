...
(fn &optional ARG)" t)
(register-definition-prefixes "persp-mode" '("*persp-" "clear-window-persp" "get-" "ido-toggle-persp-filter" "persp" "safe-persp-" "set-" "window-persp-set-p" "with-persp-ido-hooks"))

;;; End of scraped data
